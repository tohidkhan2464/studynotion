...
const ContactUs = () => {
  return (
    <div className="bg-richblack-900 text-white">
      <div className="py-[50px] pt-[100px] w-11/12 max-w-maxContent mx-auto flex flex-row gap-14">
        <div className="w-[450px] min-w-[450px] bg-richblack-800 h-fit rounded-xl p-6 flex flex-col gap-6">
        ...
        <div className="border-[2px] border-richblack-700 rounded-xl p-10">
          <div className="flex flex-col items-center justify-center gap-2 mx-auto my-12 p-5">
