    ...
    >
      {!open && (
        <div className=" flex justify-end w-full relative cursor-pointer gap-x-1 transition-all duration-200 ">
          <CiCircleChevRight className="text-4xl absolute -top-[17px] -left-1 z-[10] bg-richblack-600 p-1 rounded-full transition-all duration-200 text-richblack-5" />
        </div>
      )}
      {open && (
        <div
        ...
        >
          <div className="fixed flex min-w-[222px] flex-col border-r-[1px] border-richblack-700 transition-all duration-200 h-[calc(100vh-3.5rem)] bg-richblack-800 py-10">
            <button className="relative" onClick={() => setOpen(!open)}>
              <div className=" flex justify-end w-full relative cursor-pointer gap-x-1 transition-all duration-200 ">
                <CiCircleChevLeft className="text-4xl absolute -left-1 -top-[39px] z-[10] bg-richblack-600 p-1 transition-all duration-200 rounded-full  text-richblack-5" />
              </div>
            </button>
            ...
            <div className="flex flex-col">
              ...
              >
                <div
                  className="flex px-8 py-2 items-center gap-x-2"
                  ref={ref}
